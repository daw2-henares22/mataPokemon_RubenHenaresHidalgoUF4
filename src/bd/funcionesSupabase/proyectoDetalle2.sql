CREATE OR REPLACE FUNCTION PROYECTOSDETALLE2() RETURNS 
TABLE(ID INT, CREATED_AT TIMESTAMP, NOMBRE TEXT, DESCRIPCION 
TEXT, USER_ID UUID, ESTADO TEXT, ENUNCIADO_ID INT
, NOMBRE_USUARIO TEXT, APELLIDOS_USUARIO TEXT, NOMBRE_ENUNCIADO 
TEXT, DEFINICION_ENUNCIADO TEXT) LANGUAGE SQL AS 
	$$
	SELECT
